...
function get_ticker(coin, cb) {
  var req_url = base_url + '/coins/markets?vs_currency=' + 'usd' + '&ids=' + 'mogwai' + '&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=1h%2C24h%2C7d';
