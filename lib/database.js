...
// drops richlist data for given coin
  ...
  update_coingecko_db: function(coin, cb) {
    coingecko.get_data(coin, function(err, obj) {
      ...
      Cmc.update({ symbol: coin }, {
        rank: obj.rank,
        current_price: obj.quotes.USD.price,
        price_btc: obj.quotes.BTC.price,  // needs to be gathered separatley
        total_volume: obj.quotes.USD.volume_24h,
        market_cap: obj.quotes.USD.market_cap,
        circulating_supply: obj.circulating_supply,
        total_supply: obj.total_supply,
        price_change_percentage_1h_in_currency: obj.quotes.USD.percent_change_1h,
        price_change_percentage_24h_in_currency: obj.quotes.USD.percent_change_24h,
        price_change_percentage_7d_in_currency: obj.quotes.USD.percent_change_7d,
        last_updated: obj.last_updated
      }, function() {
        Stats.updateOne({coin:settings.coin}, {
          last_price: obj.quotes.BTC.price, // needs to be gathered separatley
        }, function(){
          return cb(null);
        });
      });
