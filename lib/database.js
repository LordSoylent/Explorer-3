    ...
    coingecko.get_data_usd(coin, function(err, obj_usd) {
      ...
      coingecko.get_data_btc(coin, function(err, obj_btc) {
		...
		Cmc.findOneAndUpdate({symbol: coin}, {
          rank: obj_usd.market_cap_rank,
          current_price: obj_usd.current_price,
          price_btc: obj_btc.current_price,
          total_volume: obj_usd.total_volume,
          market_cap: obj_usd.market_cap,
          circulating_supply: obj_usd.circulating_supply,
          total_supply: obj_usd.total_supply,
          price_change_percentage_1h_in_currency: obj_usd.price_change_percentage_1h_in_currency,
          price_change_percentage_24h_in_currency: obj_usd.price_change_percentage_24h_in_currency,
          price_change_percentage_7d_in_currency: obj_usd.price_change_percentage_7d_in_currency,
