    ...
    coingecko.get_data_usd(coin, function(err, obj_usd) {
      ...
      coingecko.get_data_btc(coin, function(err, obj_btc) {
		...
		var update = {
          ...
          price_usd: obj_usd.current_price.toString(),
          price_btc: obj_btc.current_price.toString(),
          volume_24h_usd: obj_usd.total_volume.toString(),
          market_cap_usd: obj_usd.market_cap.toString(),
          available_supply: obj_usd.circulating_supply.toString(),
          total_supply: obj_usd.total_supply.toString(),
          percent_change_1h: obj_usd.price_change_percentage_1h_in_currency.toString(),
          percent_change_24h: obj_usd.price_change_percentage_24h_in_currency.toString(),
          percent_change_7d: obj_usd.price_change_percentage_7d_in_currency.toString(),
